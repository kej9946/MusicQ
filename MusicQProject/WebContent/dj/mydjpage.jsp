...
<%
String djId = (String) session.getAttribute("djId");
String uId = (String) session.getAttribute("loginCode");
String redirectURL = request.getContextPath() + "/dj/djsearch.do?uid=" + URLEncoder.encode(uId, "UTF-8");

String djpImgCd = (String) request.getAttribute("djpImgPath");
String djpDjimgCd = (String) request.getAttribute("djpDjimgPath");
String djNm = (String) request.getAttribute("djNm");
String djpIntro = (String) request.getAttribute("djpIntro");
String djpNm = (String) request.getAttribute("djpNm");
String djpSns = (String) request.getAttribute("djpSns");
String djpSnsCorp = (String) request.getAttribute("djpSnsCorp");
String djpGenre = (String) request.getAttribute("djpGenre");
String djpKeywd = (String) request.getAttribute("djpKeywd");
...
<aside>
	...
	<main>
		<section class="py-5 text-center container">
			<div class="background-image">
				<img src="${pageContext.request.contextPath}<%= djpImgCd %>"
			...
			<div class="card mb-3" style="max-width: 100%; margin-top: 20px;">
				<div class="row g-0">
					<div class="col-md-4" style="width: 300px; margin: 20px;">
						<img src="${pageContext.request.contextPath}<%= djpDjimgCd %>"
  ...
  <path fill-rule="evenodd"
								...
								<%=djNm%>(<%=session.getAttribute("loginCode")%>님)
							</h5>
							<p class="card-text"><%=djpNm%></p>
							<p class="card-text"><%=djpIntro%></p>
							<p class="card-text">
								대표장르/키워드 #<%=djpGenre%>
								#<%=djpKeywd%></p>

							<p class="card-text">
								<a href="<%=djpSns%>" class="btn btn-primary my-2"><%=djpSnsCorp%></a>
			...
			<section>
				...
				<a href="djsearch.do?uId=<%=uId%>">마이 플레이리스트로 이동</a>
				...
				<!--댓글 창 영역  -->
				<article>
					<iframe src="cmntinsert.jsp?djId=<%=djId%>" frameborder="0" width="100%" height="100%"></iframe>
				</article>
			</section>
	</main>
				<!--댓글작성영역  -->
<h4>DJ <%=djNm%>님의 플레이리스트</h4>
<img src="../dj/djimages/플레이리스트.png" class="img-fluid" alt="마이플레이리스트">



<h4><br><br>DJ <%=djNm%>님의 방명록</h4>
				
				<main class="iframe-container1">
					<iframe src="${pageContext.request.contextPath}/cmntList.do?djId=<%=djId%>"
						frameborder="0" width="100%" height="100%"></iframe>
					</article>		
				
				
					<main class="iframe-container2">
						<iframe src="cmntinsert.jsp?djId=<%=djId%>"
							frameborder="0" width="100%" height="100%"></iframe>
						</article>
