...
<%
   ...
   List<MusicVO> mRank = mus.selectRank();

%>
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>뮤직큐 종합차트</title>
    <style>
        .img_box {
         /*    background: red; */
            margin-right: 10px;
...
<div class="music_title"><h3>뮤직큐차트 종합</h3></div>
    <div class="all_wrap">
        <div class="side_bar">
            <ul>
...
<%for(int i=0; i<9;i++){ %>
            <div class="img_box">
            <a href=../ListeningMusicController?mCd=<%=mRank.get(i).getmCd()%>>
            <img id="music_img" src=".<%=mus.selectImgPath(mRank.get(i).getmCd())%>"/>
            <div><span><%=mRank.get(i).getmNm()%></span></div>
            </a>
            </div>
            <%} %>
        </div>
