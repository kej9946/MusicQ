...
<div class="music_title"><h3>뮤직큐 국내차트 종합</h3></div>
    <div class="all_wrap">
        <div class="side_bar">
            <ul>
...
<%for(int i=0; i<9;i++){ %>
            <div class="img_box">
            <a href=../ListeningMusicController?mCd=<%=mKor.get(i).getmCd()%>>
            <img id="music_img" src=".<%=mus.selectImgPath(mKor.get(i).getmCd())%>"/>
            <div><span><%=mKor.get(i).getmNm()%></span></div>
            </a>
            </div>
            <%} %>
        </div>
